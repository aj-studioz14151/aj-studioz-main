      ...
      <div className="px-4 pt-3 pb-3 relative">
        ...
        {onDelete && (
          <button
            ...
            className={cn(
              'absolute top-2 right-2 rounded-full p-2 transition-all duration-150 bg-secondary text-muted-foreground hover:bg-destructive hover:text-destructive-foreground',
